...
Following on from this, the Weibull distribution was again considered, but with added random effect describing the litter, $\boldsymbol{b}$, taken into consideration. So it can be seen that the scale of the Weibull distribution is then altered to the exponent of $\eta_i$. Where $\eta_i$ is now as follows:
