...
These arguments are then used to construct the function. The $R$ code below displays the function \texttt{lfyb}.
...
Following this, the gradient has been computed numerically. The following $R$ code has been used to do so.
...
The maximum likelihood of the vector of parameters 
